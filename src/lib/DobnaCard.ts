...
export const DOBNA_CARDS: DobnaCardData[] = [
  ...
  { cardNumber: 31, row1: [1, 0, 22, 0, 45, 53, 0, 78, 0], row2: [0, 14, 0, 37, 0, 0, 67, 0, 85], row3: [7, 0, 0, 32, 48, 59, 0, 72, 90] },
  { cardNumber: 32, row1: [0, 11, 23, 35, 0, 0, 64, 0, 83], row2: [5, 0, 0, 0, 44, 58, 0, 77, 0], row3: [0, 18, 29, 0, 49, 0, 61, 79, 86] },
  { cardNumber: 33, row1: [3, 0, 0, 31, 0, 56, 68, 0, 81], row2: [0, 12, 28, 0, 42, 0, 0, 73, 0], row3: [9, 0, 0, 38, 47, 0, 69, 0, 88] },
  { cardNumber: 34, row1: [0, 15, 24, 0, 41, 52, 0, 71, 82], row2: [2, 0, 0, 34, 0, 0, 62, 0, 0], row3: [8, 0, 27, 39, 0, 57, 0, 76, 89] },
  { cardNumber: 35, row1: [6, 0, 21, 33, 0, 54, 66, 0, 84], row2: [0, 13, 0, 0, 46, 0, 63, 75, 0], row3: [0, 19, 26, 0, 43, 55, 0, 74, 87] },
  { cardNumber: 36, row1: [0, 16, 25, 0, 0, 51, 0, 70, 80], row2: [4, 0, 0, 36, 47, 0, 65, 0, 88], row3: [0, 20, 0, 39, 0, 58, 0, 77, 90] },
  { cardNumber: 37, row1: [8, 0, 20, 34, 0, 55, 0, 74, 85], row2: [0, 17, 0, 0, 44, 0, 66, 79, 0], row3: [1, 0, 28, 0, 49, 57, 0, 0, 87] },
  { cardNumber: 38, row1: [0, 10, 0, 30, 45, 0, 62, 0, 82], row2: [5, 0, 24, 0, 0, 53, 0, 76, 0], row3: [9, 0, 0, 38, 48, 0, 69, 78, 90] },
  { cardNumber: 39, row1: [2, 0, 21, 0, 42, 56, 0, 71, 84], row2: [0, 14, 0, 35, 0, 0, 64, 0, 86], row3: [7, 0, 29, 0, 49, 58, 0, 75, 0] },
  { cardNumber: 40, row1: [0, 18, 26, 37, 0, 52, 67, 0, 83], row2: [3, 0, 0, 0, 46, 0, 0, 73, 89], row3: [0, 11, 0, 39, 47, 59, 68, 0, 0] },
  { cardNumber: 41, row1: [4, 0, 22, 0, 43, 54, 0, 72, 81], row2: [0, 12, 0, 34, 0, 0, 63, 0, 87], row3: [6, 0, 27, 0, 48, 57, 0, 77, 90] },
  { cardNumber: 42, row1: [0, 13, 23, 0, 41, 55, 65, 0, 85], row2: [7, 0, 0, 36, 0, 0, 0, 74, 0], row3: [0, 19, 0, 38, 49, 56, 68, 79, 0] },
  { cardNumber: 43, row1: [1, 0, 25, 33, 0, 51, 0, 70, 88], row2: [0, 15, 0, 0, 45, 0, 62, 0, 0], row3: [8, 0, 28, 0, 47, 58, 0, 76, 89] },
  { cardNumber: 44, row1: [0, 10, 0, 31, 44, 0, 66, 0, 82], row2: [5, 0, 24, 0, 0, 53, 0, 75, 86], row3: [9, 0, 0, 39, 48, 0, 69, 78, 0] },
  { cardNumber: 45, row1: [2, 0, 20, 0, 42, 56, 0, 71, 84], row2: [0, 16, 0, 35, 0, 0, 64, 0, 87], row3: [7, 0, 29, 0, 49, 57, 0, 74, 90] },
  { cardNumber: 46, row1: [0, 17, 26, 37, 0, 52, 67, 0, 83], row2: [3, 0, 0, 0, 46, 0, 0, 73, 88], row3: [0, 12, 0, 38, 47, 59, 68, 0, 0] },
  { cardNumber: 47, row1: [4, 0, 21, 0, 43, 54, 0, 72, 81], row2: [0, 11, 0, 34, 0, 0, 63, 0, 86], row3: [6, 0, 27, 0, 48, 56, 0, 77, 90] },
  { cardNumber: 48, row1: [0, 14, 23, 0, 41, 55, 65, 0, 85], row2: [8, 0, 0, 36, 0, 0, 0, 74, 0], row3: [0, 18, 0, 39, 49, 57, 67, 78, 0] },
  { cardNumber: 49, row1: [1, 0, 24, 32, 0, 50, 0, 70, 89], row2: [0, 15, 0, 0, 44, 0, 61, 0, 0], row3: [9, 0, 28, 0, 47, 58, 0, 76, 88] },
  { cardNumber: 50, row1: [0, 19, 0, 30, 45, 0, 66, 0, 82], row2: [5, 0, 25, 0, 0, 53, 0, 75, 86], row3: [8, 0, 0, 38, 48, 0, 69, 77, 0] },
  { cardNumber: 51, row1: [2, 0, 22, 0, 42, 56, 0, 71, 83], row2: [0, 13, 0, 35, 0, 0, 64, 0, 87], row3: [7, 0, 29, 0, 49, 57, 0, 74, 90] },
  { cardNumber: 52, row1: [0, 16, 26, 37, 0, 52, 67, 0, 84], row2: [3, 0, 0, 0, 46, 0, 0, 73, 89], row3: [0, 11, 0, 39, 47, 58, 68, 0, 0] },
  { cardNumber: 53, row1: [4, 0, 20, 0, 43, 54, 0, 72, 81], row2: [0, 12, 0, 34, 0, 0, 63, 0, 86], row3: [6, 0, 27, 0, 48, 56, 0, 77, 90] },
  { cardNumber: 54, row1: [0, 17, 23, 0, 41, 55, 65, 0, 85], row2: [8, 0, 0, 36, 0, 0, 0, 74, 0], row3: [0, 18, 0, 38, 49, 57, 67, 79, 0] },
  { cardNumber: 55, row1: [1, 0, 25, 33, 0, 51, 0, 70, 88], row2: [0, 14, 0, 0, 45, 0, 62, 0, 0], row3: [9, 0, 28, 0, 47, 58, 0, 76, 89] },
  { cardNumber: 56, row1: [0, 10, 0, 31, 44, 0, 66, 0, 82], row2: [5, 0, 24, 0, 0, 53, 0, 75, 86], row3: [8, 0, 0, 39, 48, 0, 69, 78, 0] },
  { cardNumber: 57, row1: [2, 0, 21, 0, 42, 56, 0, 71, 84], row2: [0, 15, 0, 35, 0, 0, 64, 0, 87], row3: [7, 0, 29, 0, 49, 57, 0, 74, 90] },
  { cardNumber: 58, row1: [0, 19, 26, 37, 0, 52, 67, 0, 83], row2: [3, 0, 0, 0, 46, 0, 0, 73, 88], row3: [0, 11, 0, 38, 47, 59, 68, 0, 0] },
  { cardNumber: 59, row1: [4, 0, 22, 0, 43, 54, 0, 72, 81], row2: [0, 13, 0, 34, 0, 0, 63, 0, 86], row3: [6, 0, 27, 0, 48, 56, 0, 77, 90] },
  { cardNumber: 60, row1: [0, 18, 23, 0, 41, 55, 65, 0, 85], row2: [8, 0, 0, 36, 0, 0, 0, 74, 0], row3: [0, 16, 0, 39, 49, 57, 67, 79, 0] }
];
